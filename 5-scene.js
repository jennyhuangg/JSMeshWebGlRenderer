...
// Base colors for each shape. c1-c4 are the cubes. c5 is the ell.
...
var c5BaseColor = vec4( 1, 0.95, 0.35, 1.0);
...
// Cube data.
var c = cube();
var cu = faceToVertProperties(c.verts, c.tris, c.norms);

// Ell data.
var e = ell();
var el = faceToVertProperties(e.verts, e.tris, e.norms);
...
window.onload = function init()
{
    ...
    gl.uniform4fv(baseColorLoc, flatten(c1BaseColor));
    ...
    // Draw L-Shape.
    // TODO: Make each face a different color.
...
// Produces three arrays with no redundant information: one for the cube's
// vertex positions, one for the triangle indices, and one for the face colors
...
// Produces three arrays with no redundant information: one for the ell's
// vertex positions, one for the triangle indices, and one for the face colors
// (one color per triangle).
function ell()
{
